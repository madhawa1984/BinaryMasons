...
<div class="container-fluid row">
    <div class="col-xs-9" id="editorContainer">
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/colorpicker.js" ></script>
            ...
            $(function() {
                ...
                $( "#droppableArea" ).droppable({
                    drop: function( event, ui ){
                        ...
                        if(parentElementID.contains("draggableButtonContainer")){
                            $('<div id="draggableButton-' + iDIndex +'"  class="btn btn-default">Default Button</div>').appendTo("#" + parentElementID).draggable({revert: "invalid"}).resizable({
                                        start:function(event,ui){
                                            ui.element.css('position','relative');
                                        }}
                            );
                            ...
                            $(document).on("click","#btnChangeText-0",function() {
                                var changedText =  document.getElementById('txtChangeTextbox').value;
                                $("#draggableLink-0").text(changedText);
                                $("#draggableLink-0").popover("hide");
                            });
                        }
                ...
                $("#btnExport").click(function(){
                    ...
                    var html = '<html><head>'
                            ...
                            +'<div class="col-xs-12>'+ element.innerHTML +'</div></div></body></html>';
                        ...
                        <div class="panel-body">
                            <ul class="list-group">
                                <li class="list-group-item" id="draggableButtonContainer-1">
                                    <div id="draggableButton-0" class="btn btn-default" type="submit">Default Button
                                    </div>
                                </li>
                                <li class="list-group-item" id="draggableLinkContainer-1">
                                    <a id="draggableLink-0" class="btn btn-link" data-toggle="popover"
                                       data-placement="bottom">Default Link</a>

                                    <div id="popover-content" class="hide">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="txtChangeTextbox" value=""/>
									    <span class="input-group-btn">
									    <button type="button" class="btn btn-default" id="btnChangeText-0">
                                            ok
                                        </button>
									        </span>
                                        </div>
                                    ...
                                    <div id="draggableInputTextArea-0">
                                        <form>
                                            <textarea class="form-control" rows="3"
                                                      placeholder="Input Text Area"></textarea>
                                        </form>
                                    </div>
                                </li>
                            </ul>
        ...
        <div class="boder col-xs-8" id="droppableArea">
        </div>

    </div>
    <div class="col-xs-3 boder" style="height:1062px;" id="chatContainer">
        &nbsp;&nbsp;
    </div>
</div>
